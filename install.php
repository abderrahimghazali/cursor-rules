...
function install_cursor_rules(array $options = []): bool {
  ...
  if ($source_dir === null) {
    ...
    if (is_valid_source_dir($temp_dir, $rules_to_install)) {
      ...
      echo "Alternatively, you can manually download the rules from https://github.com/abderrahimghazali/cursor-rules\n";
      return false;
    }
  }
  ...
  $update_content .= "\n## Source\n";
  $update_content .= "Rules downloaded from: https://github.com/abderrahimghazali/cursor-rules\n";
